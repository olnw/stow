...
** Completions
I use Helm as my completion framework. The configuration file used by Helm’s maintainer is a useful reference, and can be found [[https://github.com/thierryvolpiatto/emacs-config/blob/main/init-helm.el][here]].
#+begin_src emacs-lisp
  (use-package helm
