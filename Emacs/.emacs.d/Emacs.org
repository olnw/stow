...
In the 'RSS Feed Reader' section, there are two functions that allow a completion framework to be used while applying Elfeed search tags; these are from [[https://protesilaos.com/emacs/dotemacs#h:0cd8ddab-55d1-40df-b3db-1234850792ba][Protesilaos Stavrou's Emacs Configuration]], which has also proved to be a useful reference.
