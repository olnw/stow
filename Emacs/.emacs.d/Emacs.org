...
**** Meow
I use Meow for modal editing. Perhaps I can combine it [[https://karthinks.com/software/avy-can-do-anything/][Avy]] for increased efficiency, although it already seems quite powerful by itself. My keyboard layout is the standard ANSI variant of Colemak-DH.
#+begin_src emacs-lisp
  (use-package meow
    :config
